...
$menuItems = [
    ...
    [
        ...
        'subItems' => [
            ['id' => 21, 'name' => 'Patients List', 'link' => base_url('patient')],
            ['id' => 22, 'name' => 'Register Patient', 'link' => base_url('patient/register')],
        ]
    ],
    [
        'id' => 3,
        ...
        'subItems' => [
            ['id' => 52, 'name' => 'Images', 'link' => base_url('image_repo')],
            ['id' => 53, 'name' => 'Upload', 'link' => base_url('image_repo/form')],
        ]
    ],
    [
        'id' => 5,
        ...
        'subItems' => [
            ['id' => 51, 'name' => 'Add new test', 'link' => base_url('urine_test')],
        ]
    ],
];
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <?php foreach ($menuItems as $menuItem) : ?>
                    <li class="nav-item">
                        <a href="<?= (getMenuHref($menuItem['id'])) ?>" class="nav-link<?= isMenuItemActive($menuItem['id']) ?>">
                        ...
                        <?php if (!empty($menuItem['subItems'])) : ?>
                            <ul class="nav nav-treeview">
                                <?php foreach ($menuItem['subItems'] as $subItem) : ?>
                                    <li class="nav-item">
                                        <a href="<?= (getMenuHref($subItem['id'])) ?>" class="nav-link<?= isSubMenuItemActive($subItem['id']) ?>">
