<div class="mt-4">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4 <?= (validation_show_error('illness_present')) ? 'has-error' : '' ?>">
            ...
            <input type="text" name="other_illness_present" id="illness_present" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Others presenting illness" />
        ...
        <div class="form-group col-md-4 <?= (validation_show_error('metastases_symptom')) ? 'has-error' : '' ?>">
            ...
            <input type="text" name="other_metastases_symptom" id="metastases_symptom" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Others symptom" />
            <input type="number" name="weight_loss" id="weight" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Weight (kg)" />
        ...
        <div class="form-group col-md-4 <?= (validation_show_error('med_history')) ? 'has-error' : '' ?>">
            ...
            <input type="text" name="other_med_history" id="med_history" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Others medical history" />
            <input type="text" name="stage" id="stage" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Specify stage" />
