<div class="mt-4">
    ...
    <div class="form-row">
        <!-- Family History -->
        <div class="form-group col-md-6 <?= (validation_show_error('family_history')) ? 'has-error' : '' ?>">
            <label for="family_history">Family History</label>
            <?= form_dropdown($family_option['name'], $family_option['options'], $family_option['selected'], $family_option['extra']) ?>
            <input type="text" name="other_family_history" id="family_history" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Others Family History" value="<?= set_value('other_family_history') ?>" />
        ...
        <!-- Past Cancer History -->
        <div class="form-group col-md-6 <?= (validation_show_error('past_cancer_history')) ? 'has-error' : '' ?>">
            ...
            <input type="text" name="other_past_cancer_history" id="past_cancer_history" class="form-control border-top-0 border-left-0 border-right-0" style="display:none;" placeholder="Others symptom" value=" <?= set_value('other_past_cancer_history') ?>" />
